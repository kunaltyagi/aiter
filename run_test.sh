...
git log --oneline -n1
HIP_VISIBLE_DEVICES=3 python op_tests/op_benchmarks/triton/bench_mha.py 2>&1 >softmax_prefill_a.txt
...
git checkout HEAD^
git log --oneline -n1
HIP_VISIBLE_DEVICES=3 python op_tests/op_benchmarks/triton/bench_mha.py 2>&1 >fma_prefill_a.txt
...
git checkout HEAD^
git log --oneline -n1
HIP_VISIBLE_DEVICES=3 python op_tests/op_benchmarks/triton/bench_mha.py 2>&1 >exp_prefill_a.txt
...
git checkout HEAD^
git log --oneline -n1
HIP_VISIBLE_DEVICES=3 python op_tests/op_benchmarks/triton/bench_mha.py 2>&1 >exp2_prefill_a.txt
...
git checkout HEAD^
git log --oneline -n1
HIP_VISIBLE_DEVICES=3 python op_tests/op_benchmarks/triton/bench_mha.py 2>&1 >baseline_prefill_a.txt
